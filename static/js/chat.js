$(document).ready(function () {
    ...
    $(function(){
        ...
        // Send to backend and get response from backend
        async function sendAndGetResponse(text){
        ...
        function processReturnedData(data){
            // let response_list = JSON.parse(data);
            console.log(data);
            console.log(typeof data); // Already object
            let response_list = data;
        ...
        $('.send_message').click(async function(){
            ...
            await sendAndGetResponse(getMessageText());
            reset();
        });
